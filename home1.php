...
<section id="slider"><!--slider-->
		<div class="container">
            ...
            <div class="col-sm-9 padding-right">
				...
				<div class="container">
  <center><h2>Select your language</h2>
  <a href="kannada.php" class="btn btn-info" role="button">KANNADA</a>
 <a href="english.php" class="btn btn-info" role="button">ENGLISH</a>
 <a href="hindi.php" class="btn btn-info" role="button">HINDI</a>
 <a href="marati.php" class="btn btn-info" role="button">MARATHI</a>
 <a href="telagu.php" class="btn btn-info" role="button">TELUGU</a>
</center></div><br>
